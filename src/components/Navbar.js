...
//                 <li><NavLink exact activeClassName={navStyles.onActive} className={navStyles.a} to='/'>Home</NavLink></li>
//                 <li><NavLink exact activeClassName={navStyles.onActive} className={navStyles.a} to='/about'>About</NavLink></li>
//                 <li><NavLink exact activeClassName={navStyles.onActive} className={navStyles.a} to='/contact'>Contact</NavLink></li>
